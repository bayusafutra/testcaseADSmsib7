...
<body>
    <h1 style="text-align: center">Verifikasi Email Srikandi Semanggi</h1><br>
    <div class="container">
        ...
        <footer>
            ...
            <a href="/" target="_blank" class="text-gray-800 text-hover-primary" style="text-decoration: none; color:black"><b>Website Srikandi Semanggi</b></a>
        </footer>
    </div>
