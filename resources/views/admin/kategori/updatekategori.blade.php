...
@section('erga')
    <div class="title mb-4">
        <h1 class="text-center" style="font-family:courier new; font-style: initial;">Update Kategori Produk</h1>
    </div>
    {{-- Start Form --}}
    ...
    @if ($errors->any())
        <div class="alert alert-danger">
            <p class="container">UPDATE TIDAK BERHASIL</p>
        </div>
    @endif
                ...
                <div class="card-body">
                    ...
                    <form action="/dash-updatekategori" method="POST" class="forms-sample">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" id="nama" placeholder="Nama kategori produk" required value="{{ old('nama', $kategori[0]->nama) }}">
                            @error('nama')
