...
@section('erga')
    <div class="title mb-4">
        <h1 class="text-center" style="font-family:courier new; font-style: initial;">Data Pesanan Srikandi
            Semanggi
        </h1>
    </div>
    <div class="row ">
                ...
                <div class="card-body">
                    <div class="row justify-content-center">
                        <div class="col" style="padding-left: 28px">
                            <h4 class="card-title">Data Semua Pesanan</h4>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <div class="text-center mt-3">
                            <strong style="color: #6C7293; font-family:courier new">Data Pesanan Srikandi Semanggi Belum
                                Ada</strong>
                        </div>
                    @else
                        @foreach ($pesanan as $kat)
                            <tr>
                                <td>
                                    <strong>{{ $pesanan->firstItem() + $loop->index }}</strong>
                                </td>
                                <td>
