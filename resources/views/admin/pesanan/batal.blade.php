...
@section('erga')
    <div class="title mb-4">
        <h1 class="text-center" style="font-family:courier new; font-style: initial;">Pesanan Batal Srikandi
            Semanggi
        </h1>
    </div>
    <div class="row ">
                ...
                <div class="card-body">
                    <div class="row justify-content-center">
                        <div class="col" style="padding-left: 28px">
                            <h4 class="card-title">Data Pesanan Batal</h4>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <div class="text-center mt-3">
                            <strong style="color: #6C7293; font-family:courier new">Data Pesanan Batal Belum
                                Ada</strong>
                        </div>
                    @else
                        @foreach ($batal as $kat)
                            <tr>
                                <td>
                                    <strong>{{ $batal->firstItem() + $loop->index }}</strong>
                                </td>
                                <td>
                                ...
                                <td>
                                    @if ($kat->pesanbatal)
                                        "{{ $kat->pesanbatal }}"
                                    @else
                                        Tenggat pembayaran habis
                                    @endif
                                </td>
                                <td>
                                    {{ \Carbon\Carbon::parse($kat->timebatal)->translatedFormat('l, d F Y H:i') }}
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
