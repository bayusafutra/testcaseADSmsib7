...
@section('erga')
    <div class="title mb-4">
        <h1 class="text-center" style="font-family:courier new; font-style: initial;">Menunggu Pengambilan Pesanan Srikandi
            Semanggi
        </h1>
    </div>
    <div class="row ">
                ...
                <div class="card-body">
                    <div class="row justify-content-center">
                        <div class="col" style="padding-left: 28px">
                            <h4 class="card-title">Data Menunggu Pengambilan Pesanan</h4>
                        </div>
                    </div>
                    ...
                    @else
                        @foreach ($diambil as $kat)
                            <tr>
                                <td>
                                    <strong>{{ $diambil->firstItem() + $loop->index }}</strong>
                                </td>
                                <td>
